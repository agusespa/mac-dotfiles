...
function M.setup()
  ...
  vim.api.nvim_set_hl(0, "@variable.builtin", { fg = M.colors.purple })
  ...
  vim.api.nvim_set_hl(0, "@attribute.builtin", { fg = M.colors.purple })
  ...
  vim.api.nvim_set_hl(0, "@function.builtin", { fg = M.colors.purple })
  ...
  vim.api.nvim_set_hl(0, "@type", { fg = M.colors.fg })
  vim.api.nvim_set_hl(0, "@type.builtin", { fg = M.colors.purple })
  ...
  vim.api.nvim_set_hl(0, "@namespace.builtin", { fg = M.colors.purple })
  ...
  vim.api.nvim_set_hl(0, "@class.builtin", { fg = M.colors.purple })
  ...
  vim.api.nvim_set_hl(0, "@type.builtin.tsx", { fg = M.colors.purple })
  ...
  vim.api.nvim_set_hl(0, "@function.builtin.python", { fg = M.colors.purple })
  -- C
